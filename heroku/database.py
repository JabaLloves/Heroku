    ...
    async def init(self):
        ...
        try:
            self._assets, _ = await utils.asset_channel(
                ...
                archive=True,
                avatar="https://i.postimg.cc/tCDQQC1f/heroku-assets.jpg" if os.environ.get("VAMHOST") else "https://raw.githubusercontent.com/coddrago/assets/refs/heads/main/heroku/heroku_assets.png",
            )
